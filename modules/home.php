...
?>
    ...
    <body>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-xs-12 col-sm-12 col-md-offset-2" style="margin-bottom: 10%;">
                            ...
                            <div class="col-md-3 col-xs-3">
                                <center>
                                    <h3 style="color: #9CDDDF;">MECH</h3></center>
                    ...
                    <div class="row">
                        <div class="col-md-8 col-xs-12 col-sm-12 col-md-offset-2">
                            ...
                            <div class="col-md-3 col-xs-3">
                                <center>
                                    <h3 style="color: #C8006D;">ECE</h3></center>
        ...
        <section data-role="section" id="section-coordinator">
            ...
            <div class="col-md-8 col-md-offset-2" style="text-align: center; margin-top: 1%;">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="input col-md-9 col-md-offset-3">
                                                ...
                                                <input type="text" minlength="10" maxlength="10" name="mobile" id="mobile" required autocomplete="off">
                                                <span class="spin"></span>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="col-md-9 col-md-offset-3" style="margin-top: 4px;">
                                                <span id="acc">Accomodation (Rs. 100 <i class="fa fa-inr fw fa-1x"></i>)</span>
                                            </div>
                                        </td>
                                        <td>
       ...
       <div class="row" style="margin-top: 1%;">
            ...
            <div class="row">
                <div class="col-md-1 col-md-offset-6 col-xs-4 col-xs-offset-4" >
                    <a href="http://seventeentech.com/blog/index.html" target="_blank"><img src="../assets/imgs/partners/engineers.png" class="img-responsive"></a>
                    <center><span>Engineer's Mugshot</span></center>
                </div>
            </div>
            <div class="row">
                <div class="col-md-1 col-md-offset-6 col-xs-4 col-xs-offset-4" >
                    <a href="https://www.instagram.com/skylark_photography_/?hl=en" target="_blank"><img src="../assets/imgs/partners/sky.png" class="img-responsive"></a>
                    <center><span>Skylark</span></center>sunphotograpy : https://www/instagram.com/sun_photography97/
                </div>
            </div>
            <div class="row">
                <div class="col-md-1 col-md-offset-6 col-xs-4 col-xs-offset-4" >
                    <a href="https://www.instagram.com/sun_photography97/" target="_blank"><img src="../assets/imgs/partners/SUN_logo_white.png" class="img-responsive"></a>
                    <center><span>SUN photography</span></center>
                </div>
            </div>
       </div>
-->
        <div class="container">
            <div class="row" style="margin-top:1%">
                ...
                <div class="col-md-2 col-xs-2 pull-right">
                    <center><a href="http://seventeentech.com/blog/index.html" target="_blank"><img src="../assets/imgs/partners/engineers.png" class="img-responsive"></a></center>
                    <center><span>Engineer's Mugshot</span></center>
                </div>
                <div class="clearfix"></div>
            </div>
            <div class="row">
                <div class="col-md-3 col-xs-3 col-md-offset-5 col-xs-offset-5">
                    <center>
                        <a href="http://technicalhub.io/" target="_blank"><img src="../assets/imgs/partners/T-Hub_logo.png" class="img-responsive"></a>
                    </center>
                    <center><span>Technical-Hub</span></center>
            ...
            <div class="row">
                <div class="col-md-2 col-xs-2 pull-left">
                    <center><a href="https://www.instagram.com/skylark_photography_/?hl=en" target="_blank"><img src="../assets/imgs/partners/sky.png" class="img-responsive"></a></center>
                    <center><span>Skylark</span></center>
                </div>
                <div class="col-md-2 col-xs-2 pull-right">
                    <center><a href="https://www.instagram.com/sun_photography97/" target="_blank"><img src="../assets/imgs/partners/SUN_logo_white.png" class="img-responsive"></a></center>
                    <center><span>SUN photography</span></center>
                </div>
                <div class="clearfix"></div>
            </div>

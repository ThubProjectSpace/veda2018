<?php
    ...
    if ($_SESSION['username']!="" && $_SESSION['username']!="thub" && $_SESSION['hostel_login']!="true") {
        echo "<script>
            location.href='dashboard.php';
        </script>";
    }
    else if ($_SESSION['username']!="" && $_SESSION['username']=="thub") {
        echo "<script>
            location.href='admin_dashboard.php';
        </script>";
    }
    else if ($_SESSION['username']!="" && $_SESSION['hostel_login']=="true") {
        echo "<script>

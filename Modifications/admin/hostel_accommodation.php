...
<?php include("aside_menu.php"); ?>
    ...
    <div class="main-panel">
        <nav class="navbar navbar-default">
            ...
            <div class="container">
                <label class="label label-danger" style="color: #fff; font-size: 13px;">NOTE : If you want to generate the Receipt Please Switch On / Allow the Popups in your Browser.</label>
            </div>
                            ...
                            <div class="content">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="dept" name="dept" class="form-control border-input" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Select Event Category</label>
                                        <select class="form-control border-input" name="event_category" id="event_category" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control border-input" name="event_name" id="event_name" required>
    ...
    <script>
        ...
        $("#event_category").on({
            change: function(){
                $("#event_name").load('load_data.php?action=events&dept='+event_category.value);
            }
        });

        /*
        $("#event_name").change(function(){
            $("#ajax-load").load('load_data.php?action=location&dept='+event_category.value+'&event='+event_name.value);
        });*/
...
<?php
    if (isset($_POST['submit'])) {
        ...
        $query = "insert into hostel_accommodation set student_code='".$roll."', student_name='".$name."', section='".$dept."', college='".$college."',location='".$location."', gender='".$gender."', mobile='".$mobile."', email='".$email."', event_dept='".$event_category."', event_name='".$event_name."',team='".$team."', team_size='".$team_size."', fee='".$fee."', added_by='".$_SESSION['username']."' ";

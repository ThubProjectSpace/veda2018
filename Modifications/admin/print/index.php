...
//name
$pdf->setXY(40,40);
$pdf->Cell(0,0,$fetch['student_name']);
...
//Help Line Numbers (heading)
$pdf->SetFont('Arial','b',10);
$pdf->setXY(10,100);
$pdf->Cell(0,0,"Help Line Numbers : ");

//Help Line Numbers
$pdf->SetFont('Arial','',10);
$pdf->setXY(10,105);
$pdf->Cell(0,0,"+91 9581135256");

$pdf->setXY(10,110);
$pdf->Cell(0,0,"+91 8247307255");

$pdf->setXY(10,115);
$pdf->Cell(0,0,"+91 8096026664 (T-Hub CEO)");

...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-xs-12 col-sm-12 col-md-offset-2" style="margin-bottom: 10%;">
                    ...
                    <div class="col-md-3 col-xs-3">
                        <center><h3 style="color: #9CDDDF;">Ignite</h3></center>
            ...
            <div class="row">
                <div class="col-md-8 col-xs-12 col-sm-12 col-md-offset-2">
                    ...
                    <div class="col-md-3 col-xs-3">
                        <center><h3 style="color: #C8006D;">Spark</h3></center>
    ...
    <section data-role="section" id="section-coordinator">
        ...
        <div class="col-md-8 col-md-offset-2" style="text-align: center; margin-top: 6%;">
    ...
    <!--<div class="alert alert-danger col-md-4 col-md-offset-4">
        ...
        <div class="container">
            <form class="col s12" method="post" onsubmit="return validateEmail(email.value,2);">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="2" align="center">
                                <div class="col-md-12">
                                    <span id="captcha_error" style="color: #FF3244; display: none;">Please Check the captcha below...</span>
                                    <div data-type="image" class="g-recaptcha" data-sitekey="6LcGly4UAAAAAL_XAFaNQkevF2WeRw1oeu2ImCSq"/></div>
                ...
                <center><button class="btn btn-primary btn-lg" name="register">Submit</button></center>
       ...
       <div class="row" style="margin-top: 5%;">
            <div class="row">
                <div class="col-md-1 col-md-offset-6" >
                    <a href="http://technicalhub.io/" target="_blank"><img src="../assets/imgs/T-Hub_logo.png" class="img-responsive"></a>
                    <h4>Technical-Hub</h4>
                </div>
            </div>
            ...
            <div class="row" >
                <div class="col-md-1 col-md-offset-6" >
                    <a href="http://seventeentech.com/17tech/" target="_blank"><img src="../assets/imgs/17tech.png" class="img-responsive"></a>
                    <h4>Seventeen tech</h4>
                </div>
            </div>
            <div class="row">
                <div class="col-md-1 col-md-offset-6" >
                    <a href="http://technicalhub.io/" target="_blank"><img src="../assets/imgs/engineers.png" class="img-responsive"></a>
                    <h4>Engineer's Mugshot</h4>
                </div>
            </div>
       </div>
    </section>
...
<?php
    if (isset($_POST['register'])) {
        ...
        if ($sel_rows<=0) {
            $query = "insert into `event_register` set regroll='".$_POST['rollno']."', regname='".$_POST['name']."', regdept='".$_POST['dept']."', regclg='".$_POST['college']."', regyear='".$_POST['year']."', regloc='".$_POST['location']."', regph='".$_POST['mobile']."', regmail='".$_POST['email']."', regacc='".$_POST['accomodation']."', regcategory='".$_POST['event_category']."', regevent='".$_POST['category_events']."' ";
            $result = mysqli_query($con, $query);

...
$ins_query="insert into event (`event_name`,`event_overview`,`event_rules`,`event_registration`,`other_conditions`,`submittedby`) values ('$event_name','$event_overview','$event_rules','$event_registration','$other_conditions','$submittedby')";
                                      ...
                                      <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control border-input" placeholder="Event Registration" name="event_registration" id="event_dates"/>

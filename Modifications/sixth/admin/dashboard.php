...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        <div class="content">
                ...
                <tr><td align="center" ><?php echo $count; ?></td><td ><?php echo $row["event_name"]; ?></td><td ><?php echo $row["event_overview"]; ?></td><td ><?php echo $row["event_rules"]; ?></td><td><?php echo $row["event_registration"]; ?></td><td ><?php echo $row["other_conditions"]; ?></td>

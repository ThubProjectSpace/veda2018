...
$update="update event set event_name='".$event_name."', event_overview='".$event_overview."',event_rules='".$event_rules."',event_registration='".$event_registration."', other_conditions='".$other_conditions."', submittedby='".$submittedby."' where id='".$id."'";

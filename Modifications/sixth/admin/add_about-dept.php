...
$status = header("Location: about-dept.php?msg=1");
}
?>
        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="about-dept.php"> About Dept. --> </a><a class="navbar-brand" href="#"> Add About Dept.</a>
                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="about" id="about" class="form-control border-input" placeholder="Name of Co-ordinator" rows="5" required></textarea>
                                            </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label></label>
